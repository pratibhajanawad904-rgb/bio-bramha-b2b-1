...
export const MobileOTPModal: React.FC<MobileOTPModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 pt-[max(1rem,env(safe-area-inset-top))] pb-[max(1.5rem,calc(env(safe-area-inset-bottom)+1rem))] bg-slate-900/60 backdrop-blur-sm">
      <div 
        className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden"
        onClick={e => e.stopPropagation()}
      >
        {/* Header */}
        <div className="relative p-5 sm:p-6 pb-4 border-b border-slate-100 flex items-center justify-between">
              ...
              <div className="mb-6">
                ...
                <div className="relative w-full">
                  ...
                  <input
                    ...
                    className="block w-full min-w-0 pl-14 pr-10 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all text-slate-900 font-mono font-bold text-base"
                  />
