              ...
              <div key={addr.id} className="flex items-start justify-between bg-slate-50 rounded-xl p-3 border border-slate-100">
                <div className="text-xs text-slate-700 space-y-0.5 min-w-0">
                  ...
                  <p className="text-slate-600">
                    {addr.city}, {addr.state || 'AP'} &bull; <span className="font-bold text-slate-800">PIN: {addr.pincode}</span>
                  </p>
                  {addr.isDefault && (
                ...
                <div className="flex items-center gap-2 shrink-0">
                  {!addr.isDefault && (
                    <button
                      ...
                      className="text-xs text-slate-500 hover:text-emerald-600 cursor-pointer p-1"
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-4 space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full min-w-0 px-3 py-2 rounded-lg border border-slate-200 text-sm focus:ring-2 focus:ring-emerald-500 focus:outline-none bg-white text-slate-900"
              />
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              ...
              <div>
                ...
                <input
                  ...
                  maxLength={6}
                  className="w-full min-w-0 px-3 py-2 rounded-lg border border-slate-200 text-sm focus:ring-2 focus:ring-emerald-500 focus:outline-none bg-white text-slate-900 font-mono"
                />
              </div>
            </div>
            ...
            <div className="flex gap-2 pt-1">
              <button
                ...
                disabled={saving}
                className="px-4 py-2 bg-emerald-600 text-white rounded-lg text-xs font-bold hover:bg-emerald-700 cursor-pointer disabled:opacity-50"
              >
