...
export const ProductCatalog: React.FC = () => {
  ...
  return (
    <div className="space-y-6 sm:space-y-8 pb-12">
      ...
      <div className="bg-white rounded-2xl p-3.5 sm:p-5 shadow-sm border border-slate-200/80 flex flex-col md:flex-row items-center justify-between gap-3.5">
        ...
        <div className="relative w-full md:w-72 shrink-0">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 rounded-xl border border-slate-200 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all bg-slate-50/50"
          />
        </div>
      </div>
      ...
      {/* Category Switcher Tabs (All / Bulk / Non-Bulk) - Streamlined on Single Line */}
          ...
          {(selectedSegment === 'all' || selectedSegment === 'bulk') && bulkProducts.length > 0 && (
            <section className="space-y-4">
              <div className="flex items-center gap-2 border-b border-amber-200 pb-2">
                ...
                <span className="bg-amber-100 text-amber-800 text-[11px] sm:text-xs font-bold px-2.5 py-0.5 rounded-full">
