...
export const GoogleAuthButton: React.FC = () => {
  ...
  const modalContent = isModalOpen ? (
    <div className="fixed inset-0 z-[9999] bg-slate-900/80 backdrop-blur-sm flex items-center justify-center p-3 sm:p-4 pt-[max(1rem,env(safe-area-inset-top))] pb-[max(1.5rem,calc(env(safe-area-inset-bottom)+1rem))] overflow-y-auto animate-fade-in">
      <div className="bg-white rounded-3xl max-w-sm w-full max-h-[90vh] overflow-y-auto p-5 sm:p-6 shadow-2xl border border-slate-200 relative text-center space-y-4 my-auto">
        <button
          onClick={closeModal}
          className="absolute right-4 top-4 w-9 h-9 rounded-full bg-slate-100 hover:bg-slate-200 flex items-center justify-center text-slate-700 transition-colors z-10 cursor-pointer"
          title="Close modal"
        >
          <X className="w-5 h-5" />
        </button>
          ...
          <form onSubmit={handleSendOTP} className="space-y-4 text-left">
            <div className="w-full">
              ...
              <div className="flex items-center gap-2 w-full">
                <span className="shrink-0 px-3 py-2.5 rounded-xl border border-slate-200 text-sm font-bold bg-slate-100 text-slate-700">
                  +91
                </span>
                <input
                  type="tel"
                  ...
                  required
                  maxLength={10}
                  className="flex-1 min-w-0 w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-slate-50 text-slate-900 font-mono tracking-wider"
                />
              </div>
            </div>
          ...
          <form onSubmit={handleVerifyOTP} className="space-y-4 text-left">
            <div className="w-full">
              ...
              <input
                ...
                required
                maxLength={6}
                className="w-full min-w-0 text-center px-4 py-3 rounded-xl border border-slate-300 text-lg font-mono font-bold tracking-widest focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-slate-50"
              />
            </div>
          ...
          <form onSubmit={handleCompleteRegistrationSubmit} className="space-y-4 text-left">
            ...
            <div>
              ...
              <input
                ...
                required
                className="w-full min-w-0 px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-slate-50 text-slate-900"
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full min-w-0 px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-emerald-500 bg-slate-50 text-slate-900"
              />
            </div>
